...
INSERT INTO `orders`(`OrderID`,`OrderDate`,`CustomerName`,`JobType`,`Quantity`,`Origin`,`Destination`,`Van_Type`,`CarrierName`,`MarkedForAction`,`NumberOfTrips`,`ETA`) VALUES
(77674749,'2020-12-07 4:58:57 PM','Farm Supply Co',1,21,'London','Toronto',0,NULL,0,NULL,NULL);
...
CREATE TABLE IF NOT EXISTS `route` (
  ...
  `DestAddress` varchar(100) DEFAULT NULL,
...
-- Dump completed on 2020-12-07 18:42:46
